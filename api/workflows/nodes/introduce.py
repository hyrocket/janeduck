...
async def introduce_word_node(state: WritingState) -> dict:
    ...
    try:
        message = await _generate_intro(word, definition, pos, examples)
...
async def _generate_intro(word: str, definition: str, pos: str, examples: list) -> str:
    ...
    user_msg = (
        ...
        "Write a 2–3 sentence introduction as JaneDuck:\n"
        "1. Introduce the word naturally (don't copy the definition verbatim)\n"
        "2. Explain its meaning in your own conversational words\n"
